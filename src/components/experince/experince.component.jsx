...
const Experince = () => {
  return (
    <section className='experince section'>
      <Heading2 primary={'Our experince'} secondary={'why adroyt'} light />
      <div className="experince_intro">
        <p className='experince_intro-text'>{data.intro}</p>
        <div className="experince_intro-img">
          <img src="https://ik.imagekit.io/ml22hal4lxj/adroyt_images/experince_bVqIjCk93.png?updatedAt=1700027778426" alt="" />
